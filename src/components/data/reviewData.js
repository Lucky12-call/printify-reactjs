export const reviewData = [
  ...
  },
  {
    id: 2,
    name: "Quinten Barney",
    business: "Etsy Merchant",
    image: "https://printify.com/pfh/media/quinten-barney-CHC7B3FG.png",
    description:
      " We chose Printify because of their offerings as well as their incredibly low prices. After several years, we have come to find that their customer service is also top notch, and their platform just keeps getting better and better.",
  },
  {
    id: 3,
    name: "Nikki",
    ...
    description:
      " Printify has been a amazing partner to work with as we grow our business, from the range of merch we can make for our customers to working with our Customer Service team (Hi Martin!) it is truly made the whole process a breeze.",
  },
  {
    id: 4,
